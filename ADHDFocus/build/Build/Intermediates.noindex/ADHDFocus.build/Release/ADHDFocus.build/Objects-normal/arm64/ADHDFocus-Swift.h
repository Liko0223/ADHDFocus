...
#ifndef ADHDFOCUS_SWIFT_H
#define ADHDFOCUS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ADHDFocus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9ADHDFocus11AppDelegate")
...
SWIFT_CLASS("_TtC9ADHDFocus17BlockOverlayPanel")
@interface BlockOverlayPanel : NSPanel
...
@class NSCoder;
SWIFT_CLASS("_TtC9ADHDFocus16NotchHitTestView")
@interface NotchHitTestView : NSView
- (NSView * _Nullable)hitTest:(NSPoint)point SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC9ADHDFocus10NotchPanel")
